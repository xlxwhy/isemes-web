...
.products-hero::before {
  ...
  right: 0;
  bottom: 0;
  background: linear-gradient(135deg, rgba(42, 61, 102, 0.9) 0%, rgba(42, 61, 102, 0.8) 100%);
  z-index: 1;
}
